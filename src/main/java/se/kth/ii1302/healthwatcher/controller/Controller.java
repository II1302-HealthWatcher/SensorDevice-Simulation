...
import se.kth.ii1302.healthwatcher.model.*;
...
public class Controller {
    private DeviceIDHandler deviceIDManager;
    private InformationProvider measurementsProvider;
    private InformationTransferProvider measurementsTransferServiceProvider;
    private EncryptionProvider encryptionServiceProvider;
     ...
     */
    public Controller(DeviceIDHandler deviceIDManager,
                      InformationTransferProvider measurementsTransferServiceProvider,
                      EncryptionProvider encryptionServiceProvider) {
    ...
    /**
     * Generate a random measurement for the current device.
    ...
    /**
     * Generate a random critical measurement for the current device.
     * @param date the desired date for the generated measurement.
     * @return a dto with the measurement information.
     */
    ...
    /**
     * Generate several measurements for the current device.
     * @param date the desired start date of the measurements.
     * @param count the number of the desired measurements count.
     * @return an array containing the measurements for the current device.
     */
    ...
    /**
     * Get the generated measurement(s) for the current device.
     * @return an array containing the measurements for the current device.
     */
     ...
     * @param transferRate the pause between each request.
